...
wire          mgmtsoc_master_tx_fifo_sink_sink_last;
...
wire   [31:0] dbg_uart_wishbone_adr;
...
reg    [1:0] mgmtsoc_litespiphy_state = 2'd0;
reg    [1:0] mgmtsoc_litespiphy_next_state = 2'd0;
...
wire    [1:0] mgmtsoc_litespi_request;
reg          mgmtsoc_litespi_grant = 1'd0;
reg          mgmtsoc_litespi_tx_mux_source_valid = 1'd0;
wire          mgmtsoc_litespi_tx_mux_source_ready;
reg          mgmtsoc_litespi_tx_mux_source_first = 1'd0;
reg          mgmtsoc_litespi_tx_mux_source_last = 1'd0;
reg   [31:0] mgmtsoc_litespi_tx_mux_source_payload_data = 32'd0;
reg    [5:0] mgmtsoc_litespi_tx_mux_source_payload_len = 6'd0;
reg    [3:0] mgmtsoc_litespi_tx_mux_source_payload_width = 4'd0;
reg    [7:0] mgmtsoc_litespi_tx_mux_source_payload_mask = 8'd0;
wire          mgmtsoc_litespi_tx_mux_endpoint0_sink_valid;
reg          mgmtsoc_litespi_tx_mux_endpoint0_sink_ready = 1'd0;
wire          mgmtsoc_litespi_tx_mux_endpoint0_sink_first;
wire          mgmtsoc_litespi_tx_mux_endpoint0_sink_last;
wire   [31:0] mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_data;
wire    [5:0] mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_len;
wire    [3:0] mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_width;
wire    [7:0] mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_mask;
wire          mgmtsoc_litespi_tx_mux_endpoint1_sink_valid;
reg          mgmtsoc_litespi_tx_mux_endpoint1_sink_ready = 1'd0;
wire          mgmtsoc_litespi_tx_mux_endpoint1_sink_first;
wire          mgmtsoc_litespi_tx_mux_endpoint1_sink_last;
wire   [31:0] mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_data;
wire    [5:0] mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_len;
wire    [3:0] mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_width;
wire    [7:0] mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_mask;
wire          mgmtsoc_litespi_tx_mux_sel;
wire          mgmtsoc_litespi_rx_demux_sink_valid;
reg          mgmtsoc_litespi_rx_demux_sink_ready = 1'd0;
wire          mgmtsoc_litespi_rx_demux_sink_first;
wire          mgmtsoc_litespi_rx_demux_sink_last;
wire   [31:0] mgmtsoc_litespi_rx_demux_sink_payload_data;
reg          mgmtsoc_litespi_rx_demux_endpoint0_source_valid = 1'd0;
wire          mgmtsoc_litespi_rx_demux_endpoint0_source_ready;
reg          mgmtsoc_litespi_rx_demux_endpoint0_source_first = 1'd0;
reg          mgmtsoc_litespi_rx_demux_endpoint0_source_last = 1'd0;
reg   [31:0] mgmtsoc_litespi_rx_demux_endpoint0_source_payload_data = 32'd0;
reg          mgmtsoc_litespi_rx_demux_endpoint1_source_valid = 1'd0;
wire          mgmtsoc_litespi_rx_demux_endpoint1_source_ready;
reg          mgmtsoc_litespi_rx_demux_endpoint1_source_first = 1'd0;
reg          mgmtsoc_litespi_rx_demux_endpoint1_source_last = 1'd0;
reg   [31:0] mgmtsoc_litespi_rx_demux_endpoint1_source_payload_data = 32'd0;
wire          mgmtsoc_litespi_rx_demux_sel;
reg    [3:0] mgmtsoc_litespi_state = 4'd0;
reg    [3:0] mgmtsoc_litespi_next_state = 4'd0;
...
reg    [1:0] mgmtsoc_spimaster_state = 2'd0;
reg    [1:0] mgmtsoc_spimaster_next_state = 2'd0;
reg    [2:0] spi_master_count_spimaster_next_value = 3'd0;
reg          spi_master_count_spimaster_next_value_ce = 1'd0;
reg          mgmtsoc_rs232phy_rs232phytx_state = 1'd0;
reg          mgmtsoc_rs232phy_rs232phytx_next_state = 1'd0;
...
reg          mgmtsoc_rs232phy_rs232phyrx_state = 1'd0;
reg          mgmtsoc_rs232phy_rs232phyrx_next_state = 1'd0;
...
reg          mgmtsoc_uartwishbonebridge_rs232phytx_state = 1'd0;
reg          mgmtsoc_uartwishbonebridge_rs232phytx_next_state = 1'd0;
...
reg          mgmtsoc_uartwishbonebridge_rs232phyrx_state = 1'd0;
reg          mgmtsoc_uartwishbonebridge_rs232phyrx_next_state = 1'd0;
...
reg    [2:0] mgmtsoc_uartwishbonebridge_state = 3'd0;
reg    [2:0] mgmtsoc_uartwishbonebridge_next_state = 3'd0;
...
wire          mgmtsoc_gpioin0_i00;
wire          mgmtsoc_gpioin0_i01;
reg          mgmtsoc_gpioin0_status = 1'd0;
reg          mgmtsoc_gpioin0_re = 1'd0;
reg          mgmtsoc_gpioin0_r = 1'd0;
reg          mgmtsoc_gpioin0_storage = 1'd0;
wire          mgmtsoc_gpioin1_i00;
wire          mgmtsoc_gpioin1_i01;
reg          mgmtsoc_gpioin1_status = 1'd0;
reg          mgmtsoc_gpioin1_re = 1'd0;
reg          mgmtsoc_gpioin1_r = 1'd0;
reg          mgmtsoc_gpioin1_storage = 1'd0;
wire          mgmtsoc_gpioin2_i00;
wire          mgmtsoc_gpioin2_i01;
reg          mgmtsoc_gpioin2_status = 1'd0;
reg          mgmtsoc_gpioin2_re = 1'd0;
reg          mgmtsoc_gpioin2_r = 1'd0;
reg          mgmtsoc_gpioin2_storage = 1'd0;
wire          mgmtsoc_gpioin3_i00;
wire          mgmtsoc_gpioin3_i01;
reg          mgmtsoc_gpioin3_status = 1'd0;
reg          mgmtsoc_gpioin3_re = 1'd0;
reg          mgmtsoc_gpioin3_r = 1'd0;
reg          mgmtsoc_gpioin3_storage = 1'd0;
wire          mgmtsoc_gpioin4_i00;
wire          mgmtsoc_gpioin4_i01;
reg          mgmtsoc_gpioin4_status = 1'd0;
reg          mgmtsoc_gpioin4_re = 1'd0;
reg          mgmtsoc_gpioin4_r = 1'd0;
reg          mgmtsoc_gpioin4_storage = 1'd0;
wire          mgmtsoc_gpioin5_i00;
wire          mgmtsoc_gpioin5_i01;
reg          mgmtsoc_gpioin5_status = 1'd0;
reg          mgmtsoc_gpioin5_re = 1'd0;
reg          mgmtsoc_gpioin5_r = 1'd0;
reg          mgmtsoc_gpioin5_storage = 1'd0;
reg          mgmtsoc_wishbone2csr_state = 1'd0;
reg          mgmtsoc_wishbone2csr_next_state = 1'd0;
reg   [31:0] comb_array_muxed0 = 32'd0;
...
assign mgmtsoc_litespi_tx_mux_endpoint0_sink_valid = mgmtsoc_port_mmap_internal_port_sink_valid;
assign mgmtsoc_port_mmap_internal_port_sink_ready = mgmtsoc_litespi_tx_mux_endpoint0_sink_ready;
assign mgmtsoc_litespi_tx_mux_endpoint0_sink_first = mgmtsoc_port_mmap_internal_port_sink_first;
assign mgmtsoc_litespi_tx_mux_endpoint0_sink_last = mgmtsoc_port_mmap_internal_port_sink_last;
assign mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_data = mgmtsoc_port_mmap_internal_port_sink_payload_data;
assign mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_len = mgmtsoc_port_mmap_internal_port_sink_payload_len;
assign mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_width = mgmtsoc_port_mmap_internal_port_sink_payload_width;
assign mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_mask = mgmtsoc_port_mmap_internal_port_sink_payload_mask;
assign mgmtsoc_port_mmap_internal_port_source_valid = mgmtsoc_litespi_rx_demux_endpoint0_source_valid;
assign mgmtsoc_litespi_rx_demux_endpoint0_source_ready = mgmtsoc_port_mmap_internal_port_source_ready;
assign mgmtsoc_port_mmap_internal_port_source_first = mgmtsoc_litespi_rx_demux_endpoint0_source_first;
assign mgmtsoc_port_mmap_internal_port_source_last = mgmtsoc_litespi_rx_demux_endpoint0_source_last;
assign mgmtsoc_port_mmap_internal_port_source_payload_data = mgmtsoc_litespi_rx_demux_endpoint0_source_payload_data;
assign mgmtsoc_litespi_tx_mux_endpoint1_sink_valid = mgmtsoc_port_master_internal_port_sink_valid;
assign mgmtsoc_port_master_internal_port_sink_ready = mgmtsoc_litespi_tx_mux_endpoint1_sink_ready;
assign mgmtsoc_litespi_tx_mux_endpoint1_sink_first = mgmtsoc_port_master_internal_port_sink_first;
assign mgmtsoc_litespi_tx_mux_endpoint1_sink_last = mgmtsoc_port_master_internal_port_sink_last;
assign mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_data = mgmtsoc_port_master_internal_port_sink_payload_data;
assign mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_len = mgmtsoc_port_master_internal_port_sink_payload_len;
assign mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_width = mgmtsoc_port_master_internal_port_sink_payload_width;
assign mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_mask = mgmtsoc_port_master_internal_port_sink_payload_mask;
assign mgmtsoc_port_master_internal_port_source_valid = mgmtsoc_litespi_rx_demux_endpoint1_source_valid;
assign mgmtsoc_litespi_rx_demux_endpoint1_source_ready = mgmtsoc_port_master_internal_port_source_ready;
assign mgmtsoc_port_master_internal_port_source_first = mgmtsoc_litespi_rx_demux_endpoint1_source_first;
assign mgmtsoc_port_master_internal_port_source_last = mgmtsoc_litespi_rx_demux_endpoint1_source_last;
assign mgmtsoc_port_master_internal_port_source_payload_data = mgmtsoc_litespi_rx_demux_endpoint1_source_payload_data;
assign mgmtsoc_litespi_request = {mgmtsoc_port_master_request, mgmtsoc_port_mmap_request};
assign mgmtsoc_crossbar_source_valid = mgmtsoc_litespi_tx_mux_source_valid;
assign mgmtsoc_litespi_tx_mux_source_ready = mgmtsoc_crossbar_source_ready;
assign mgmtsoc_crossbar_source_first = mgmtsoc_litespi_tx_mux_source_first;
assign mgmtsoc_crossbar_source_last = mgmtsoc_litespi_tx_mux_source_last;
assign mgmtsoc_crossbar_source_payload_data = mgmtsoc_litespi_tx_mux_source_payload_data;
assign mgmtsoc_crossbar_source_payload_len = mgmtsoc_litespi_tx_mux_source_payload_len;
assign mgmtsoc_crossbar_source_payload_width = mgmtsoc_litespi_tx_mux_source_payload_width;
assign mgmtsoc_crossbar_source_payload_mask = mgmtsoc_litespi_tx_mux_source_payload_mask;
assign mgmtsoc_litespi_tx_mux_sel = mgmtsoc_litespi_grant;
assign mgmtsoc_litespi_rx_demux_sink_valid = mgmtsoc_crossbar_sink_valid;
assign mgmtsoc_crossbar_sink_ready = mgmtsoc_litespi_rx_demux_sink_ready;
assign mgmtsoc_litespi_rx_demux_sink_first = mgmtsoc_crossbar_sink_first;
assign mgmtsoc_litespi_rx_demux_sink_last = mgmtsoc_crossbar_sink_last;
assign mgmtsoc_litespi_rx_demux_sink_payload_data = mgmtsoc_crossbar_sink_payload_data;
assign mgmtsoc_litespi_rx_demux_sel = mgmtsoc_litespi_grant;
always @(*) begin
	mgmtsoc_crossbar_cs = 1'd0;
    case (mgmtsoc_litespi_grant)
        1'd0: begin
...
always @(*) begin
	mgmtsoc_litespi_tx_mux_source_payload_len = 6'd0;
    case (mgmtsoc_litespi_tx_mux_sel)
        1'd0: begin
            mgmtsoc_litespi_tx_mux_source_payload_len = mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_len;
        end
        1'd1: begin
            mgmtsoc_litespi_tx_mux_source_payload_len = mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_len;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_tx_mux_source_payload_width = 4'd0;
    case (mgmtsoc_litespi_tx_mux_sel)
        1'd0: begin
            mgmtsoc_litespi_tx_mux_source_payload_width = mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_width;
        end
        1'd1: begin
            mgmtsoc_litespi_tx_mux_source_payload_width = mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_width;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_tx_mux_source_payload_mask = 8'd0;
    case (mgmtsoc_litespi_tx_mux_sel)
        1'd0: begin
            mgmtsoc_litespi_tx_mux_source_payload_mask = mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_mask;
        end
        1'd1: begin
            mgmtsoc_litespi_tx_mux_source_payload_mask = mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_mask;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_tx_mux_endpoint0_sink_ready = 1'd0;
    case (mgmtsoc_litespi_tx_mux_sel)
        1'd0: begin
            mgmtsoc_litespi_tx_mux_endpoint0_sink_ready = mgmtsoc_litespi_tx_mux_source_ready;
        end
        1'd1: begin
        end
    endcase
...
always @(*) begin
	mgmtsoc_litespi_tx_mux_source_valid = 1'd0;
    case (mgmtsoc_litespi_tx_mux_sel)
        1'd0: begin
            mgmtsoc_litespi_tx_mux_source_valid = mgmtsoc_litespi_tx_mux_endpoint0_sink_valid;
        end
        1'd1: begin
            mgmtsoc_litespi_tx_mux_source_valid = mgmtsoc_litespi_tx_mux_endpoint1_sink_valid;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_tx_mux_endpoint1_sink_ready = 1'd0;
    case (mgmtsoc_litespi_tx_mux_sel)
        1'd0: begin
        end
        1'd1: begin
            mgmtsoc_litespi_tx_mux_endpoint1_sink_ready = mgmtsoc_litespi_tx_mux_source_ready;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_tx_mux_source_first = 1'd0;
    case (mgmtsoc_litespi_tx_mux_sel)
        1'd0: begin
            mgmtsoc_litespi_tx_mux_source_first = mgmtsoc_litespi_tx_mux_endpoint0_sink_first;
        end
        1'd1: begin
            mgmtsoc_litespi_tx_mux_source_first = mgmtsoc_litespi_tx_mux_endpoint1_sink_first;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_tx_mux_source_last = 1'd0;
    case (mgmtsoc_litespi_tx_mux_sel)
        1'd0: begin
            mgmtsoc_litespi_tx_mux_source_last = mgmtsoc_litespi_tx_mux_endpoint0_sink_last;
        end
        1'd1: begin
            mgmtsoc_litespi_tx_mux_source_last = mgmtsoc_litespi_tx_mux_endpoint1_sink_last;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_tx_mux_source_payload_data = 32'd0;
    case (mgmtsoc_litespi_tx_mux_sel)
        1'd0: begin
            mgmtsoc_litespi_tx_mux_source_payload_data = mgmtsoc_litespi_tx_mux_endpoint0_sink_payload_data;
        end
        1'd1: begin
            mgmtsoc_litespi_tx_mux_source_payload_data = mgmtsoc_litespi_tx_mux_endpoint1_sink_payload_data;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_rx_demux_endpoint1_source_first = 1'd0;
    case (mgmtsoc_litespi_rx_demux_sel)
        1'd0: begin
        end
        1'd1: begin
            mgmtsoc_litespi_rx_demux_endpoint1_source_first = mgmtsoc_litespi_rx_demux_sink_first;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_rx_demux_endpoint1_source_last = 1'd0;
    case (mgmtsoc_litespi_rx_demux_sel)
        1'd0: begin
        end
        1'd1: begin
            mgmtsoc_litespi_rx_demux_endpoint1_source_last = mgmtsoc_litespi_rx_demux_sink_last;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_rx_demux_endpoint1_source_payload_data = 32'd0;
    case (mgmtsoc_litespi_rx_demux_sel)
        1'd0: begin
        end
        1'd1: begin
            mgmtsoc_litespi_rx_demux_endpoint1_source_payload_data = mgmtsoc_litespi_rx_demux_sink_payload_data;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_rx_demux_sink_ready = 1'd0;
    case (mgmtsoc_litespi_rx_demux_sel)
        1'd0: begin
            mgmtsoc_litespi_rx_demux_sink_ready = mgmtsoc_litespi_rx_demux_endpoint0_source_ready;
        end
        1'd1: begin
            mgmtsoc_litespi_rx_demux_sink_ready = mgmtsoc_litespi_rx_demux_endpoint1_source_ready;
        end
    endcase
end
always @(*) begin
	mgmtsoc_litespi_rx_demux_endpoint0_source_valid = 1'd0;
    case (mgmtsoc_litespi_rx_demux_sel)
        1'd0: begin
            mgmtsoc_litespi_rx_demux_endpoint0_source_valid = mgmtsoc_litespi_rx_demux_sink_valid;
        end
        1'd1: begin
        end
    endcase
...
always @(*) begin
	mgmtsoc_litespi_rx_demux_endpoint0_source_first = 1'd0;
    case (mgmtsoc_litespi_rx_demux_sel)
        1'd0: begin
            mgmtsoc_litespi_rx_demux_endpoint0_source_first = mgmtsoc_litespi_rx_demux_sink_first;
        end
        1'd1: begin
        end
    endcase
...
always @(*) begin
	mgmtsoc_litespi_rx_demux_endpoint0_source_last = 1'd0;
    case (mgmtsoc_litespi_rx_demux_sel)
        1'd0: begin
            mgmtsoc_litespi_rx_demux_endpoint0_source_last = mgmtsoc_litespi_rx_demux_sink_last;
        end
        1'd1: begin
        end
    endcase
...
always @(*) begin
	mgmtsoc_litespi_rx_demux_endpoint0_source_payload_data = 32'd0;
    case (mgmtsoc_litespi_rx_demux_sel)
        1'd0: begin
            mgmtsoc_litespi_rx_demux_endpoint0_source_payload_data = mgmtsoc_litespi_rx_demux_sink_payload_data;
        end
        1'd1: begin
        end
    endcase
...
always @(*) begin
	mgmtsoc_litespi_rx_demux_endpoint1_source_valid = 1'd0;
    case (mgmtsoc_litespi_rx_demux_sel)
        1'd0: begin
        end
        1'd1: begin
            mgmtsoc_litespi_rx_demux_endpoint1_source_valid = mgmtsoc_litespi_rx_demux_sink_valid;
        end
    endcase
end
...
always @(*) begin
	mgmtsoc_litespi_next_state = 4'd0;
    mgmtsoc_litespi_next_state = mgmtsoc_litespi_state;
    case (mgmtsoc_litespi_state)
        1'd1: begin
            if (mgmtsoc_litespimmap_source_ready) begin
                mgmtsoc_litespi_next_state = 2'd2;
            end
        end
        2'd2: begin
            if (mgmtsoc_litespimmap_sink_valid) begin
                mgmtsoc_litespi_next_state = 2'd3;
            end
        end
        2'd3: begin
            if (mgmtsoc_litespimmap_source_ready) begin
                mgmtsoc_litespi_next_state = 3'd4;
            end
        end
        3'd4: begin
            if (mgmtsoc_litespimmap_sink_valid) begin
                if ((mgmtsoc_litespimmap_spi_dummy_bits == 1'd0)) begin
                    mgmtsoc_litespi_next_state = 3'd7;
                end else begin
                    mgmtsoc_litespi_next_state = 3'd5;
                end
            end
        end
        3'd5: begin
            if (mgmtsoc_litespimmap_source_ready) begin
                mgmtsoc_litespi_next_state = 3'd6;
            end
        end
        3'd6: begin
            if (mgmtsoc_litespimmap_sink_valid) begin
        ...
        3'd7: begin
            if (mgmtsoc_litespimmap_source_ready) begin
                mgmtsoc_litespi_next_state = 4'd8;
            end
        end
        4'd8: begin
            if (mgmtsoc_litespimmap_sink_valid) begin
                mgmtsoc_litespi_next_state = 1'd0;
            end
        end
        default: begin
            if (((mgmtsoc_litespimmap_bus_cyc & mgmtsoc_litespimmap_bus_stb) & (~mgmtsoc_litespimmap_bus_we))) begin
                if ((mgmtsoc_litespimmap_burst_cs & (mgmtsoc_litespimmap_bus_adr == mgmtsoc_litespimmap_burst_adr))) begin
                    ...
                    mgmtsoc_litespi_next_state = 1'd1;
                end
            end
        end
    endcase
...
assign mgmtsoc_master_tx_fifo_sink_sink_last = 1'd1;
...
always @(*) begin
	mgmtsoc_spimaster_next_state = 2'd0;
    mgmtsoc_spimaster_next_state = mgmtsoc_spimaster_state;
    case (mgmtsoc_spimaster_state)
        1'd1: begin
            if (spi_master_clk_fall) begin
                mgmtsoc_spimaster_next_state = 2'd2;
            end
        end
        2'd2: begin
            if (spi_master_clk_fall) begin
                if ((spi_master_count == (spi_master_length0 - 1'd1))) begin
                    mgmtsoc_spimaster_next_state = 2'd3;
                end
            end
        end
        2'd3: begin
            if (spi_master_clk_rise) begin
                mgmtsoc_spimaster_next_state = 1'd0;
            end
        end
        default: begin
            if (spi_master_start0) begin
                mgmtsoc_spimaster_next_state = 1'd1;
            end
        end
    endcase
end
...
always @(*) begin
	mgmtsoc_rs232phy_rs232phytx_next_state = 1'd0;
    mgmtsoc_rs232phy_rs232phytx_next_state = mgmtsoc_rs232phy_rs232phytx_state;
    case (mgmtsoc_rs232phy_rs232phytx_state)
        1'd1: begin
        ...
        default: begin
            if (uart_phy_tx_sink_valid) begin
                mgmtsoc_rs232phy_rs232phytx_next_state = 1'd1;
            end
        end
    endcase
end
...
always @(*) begin
	mgmtsoc_rs232phy_rs232phyrx_next_state = 1'd0;
    mgmtsoc_rs232phy_rs232phyrx_next_state = mgmtsoc_rs232phy_rs232phyrx_state;
    case (mgmtsoc_rs232phy_rs232phyrx_state)
        1'd1: begin
        ...
        default: begin
            if (((uart_phy_rx_rx == 1'd0) & (uart_phy_rx_rx_d == 1'd1))) begin
                mgmtsoc_rs232phy_rs232phyrx_next_state = 1'd1;
            end
        end
    endcase
end
...
always @(*) begin
	mgmtsoc_uartwishbonebridge_rs232phytx_next_state = 1'd0;
    mgmtsoc_uartwishbonebridge_rs232phytx_next_state = mgmtsoc_uartwishbonebridge_rs232phytx_state;
    case (mgmtsoc_uartwishbonebridge_rs232phytx_state)
        1'd1: begin
        ...
        default: begin
            if (dbg_uart_tx_sink_valid) begin
                mgmtsoc_uartwishbonebridge_rs232phytx_next_state = 1'd1;
            end
        end
    endcase
end
...
always @(*) begin
	mgmtsoc_uartwishbonebridge_rs232phyrx_next_state = 1'd0;
    mgmtsoc_uartwishbonebridge_rs232phyrx_next_state = mgmtsoc_uartwishbonebridge_rs232phyrx_state;
    case (mgmtsoc_uartwishbonebridge_rs232phyrx_state)
        1'd1: begin
        ...
        default: begin
            if (((dbg_uart_rx_rx == 1'd0) & (dbg_uart_rx_rx_d == 1'd1))) begin
                mgmtsoc_uartwishbonebridge_rs232phyrx_next_state = 1'd1;
            end
        end
    endcase
end
...
always @(*) begin
	mgmtsoc_uartwishbonebridge_next_state = 3'd0;
    mgmtsoc_uartwishbonebridge_next_state = mgmtsoc_uartwishbonebridge_state;
    case (mgmtsoc_uartwishbonebridge_state)
        1'd1: begin
            if (dbg_uart_rx_source_valid) begin
                mgmtsoc_uartwishbonebridge_next_state = 2'd2;
            end
        end
        2'd2: begin
            if (dbg_uart_rx_source_valid) begin
                if ((dbg_uart_addr_bytes_count == 2'd3)) begin
                    if (((dbg_uart_cmd == 1'd1) | (dbg_uart_cmd == 2'd3))) begin
                        mgmtsoc_uartwishbonebridge_next_state = 2'd3;
                    end else begin
                        if (((dbg_uart_cmd == 2'd2) | (dbg_uart_cmd == 3'd4))) begin
                            mgmtsoc_uartwishbonebridge_next_state = 3'd5;
                        end else begin
                            mgmtsoc_uartwishbonebridge_next_state = 1'd0;
                        end
                    end
                end
            end
        ...
        2'd3: begin
            if (dbg_uart_rx_source_valid) begin
                if ((dbg_uart_data_bytes_count == 2'd3)) begin
                    mgmtsoc_uartwishbonebridge_next_state = 3'd4;
                end
            end
        end
        3'd4: begin
        ...
        3'd5: begin
            if (dbg_uart_wishbone_ack) begin
                mgmtsoc_uartwishbonebridge_next_state = 3'd6;
            end
        end
        3'd6: begin
        ...
        default: begin
            if (dbg_uart_rx_source_valid) begin
                mgmtsoc_uartwishbonebridge_next_state = 1'd1;
            end
        end
    endcase
end
...
assign mgmtsoc_gpioin0_i00 = gpioin0_gpioin0_status;
assign mgmtsoc_gpioin0_i01 = gpioin0_gpioin0_pending;
always @(*) begin
	gpioin0_gpioin0_clear = 1'd0;
    if ((mgmtsoc_gpioin0_re & mgmtsoc_gpioin0_r)) begin
        gpioin0_gpioin0_clear = 1'd1;
    end
end
assign gpioin0_gpioin0_irq = (mgmtsoc_gpioin0_status & mgmtsoc_gpioin0_storage);
...
assign mgmtsoc_gpioin1_i00 = gpioin1_gpioin1_status;
assign mgmtsoc_gpioin1_i01 = gpioin1_gpioin1_pending;
always @(*) begin
	gpioin1_gpioin1_clear = 1'd0;
    if ((mgmtsoc_gpioin1_re & mgmtsoc_gpioin1_r)) begin
        gpioin1_gpioin1_clear = 1'd1;
    end
end
assign gpioin1_gpioin1_irq = (mgmtsoc_gpioin1_status & mgmtsoc_gpioin1_storage);
...
assign mgmtsoc_gpioin2_i00 = gpioin2_gpioin2_status;
assign mgmtsoc_gpioin2_i01 = gpioin2_gpioin2_pending;
always @(*) begin
	gpioin2_gpioin2_clear = 1'd0;
    if ((mgmtsoc_gpioin2_re & mgmtsoc_gpioin2_r)) begin
        gpioin2_gpioin2_clear = 1'd1;
    end
end
assign gpioin2_gpioin2_irq = (mgmtsoc_gpioin2_status & mgmtsoc_gpioin2_storage);
...
assign mgmtsoc_gpioin3_i00 = gpioin3_gpioin3_status;
assign mgmtsoc_gpioin3_i01 = gpioin3_gpioin3_pending;
always @(*) begin
	gpioin3_gpioin3_clear = 1'd0;
    if ((mgmtsoc_gpioin3_re & mgmtsoc_gpioin3_r)) begin
        gpioin3_gpioin3_clear = 1'd1;
    end
end
assign gpioin3_gpioin3_irq = (mgmtsoc_gpioin3_status & mgmtsoc_gpioin3_storage);
...
assign mgmtsoc_gpioin4_i00 = gpioin4_gpioin4_status;
assign mgmtsoc_gpioin4_i01 = gpioin4_gpioin4_pending;
always @(*) begin
	gpioin4_gpioin4_clear = 1'd0;
    if ((mgmtsoc_gpioin4_re & mgmtsoc_gpioin4_r)) begin
        gpioin4_gpioin4_clear = 1'd1;
    end
end
assign gpioin4_gpioin4_irq = (mgmtsoc_gpioin4_status & mgmtsoc_gpioin4_storage);
...
assign mgmtsoc_gpioin5_i00 = gpioin5_gpioin5_status;
assign mgmtsoc_gpioin5_i01 = gpioin5_gpioin5_pending;
always @(*) begin
	gpioin5_gpioin5_clear = 1'd0;
    if ((mgmtsoc_gpioin5_re & mgmtsoc_gpioin5_r)) begin
        gpioin5_gpioin5_clear = 1'd1;
    end
end
assign gpioin5_gpioin5_irq = (mgmtsoc_gpioin5_status & mgmtsoc_gpioin5_storage);
assign gpioin5_gpioin5_status = gpioin5_gpioin5_trigger;
always @(*) begin
	mgmtsoc_wishbone2csr_next_state = 1'd0;
    mgmtsoc_wishbone2csr_next_state = mgmtsoc_wishbone2csr_state;
    case (mgmtsoc_wishbone2csr_state)
        1'd1: begin
            mgmtsoc_wishbone2csr_next_state = 1'd0;
        end
        default: begin
            if ((mgmtsoc_wishbone_cyc & mgmtsoc_wishbone_stb)) begin
                mgmtsoc_wishbone2csr_next_state = 1'd1;
            end
        end
    endcase
end
...
always @(posedge sys_clk) begin
    ...
    mgmtsoc_litespiphy_state <= mgmtsoc_litespiphy_next_state;
    ...
    case (mgmtsoc_litespi_grant)
        1'd0: begin
            if ((~mgmtsoc_litespi_request[0])) begin
                if (mgmtsoc_litespi_request[1]) begin
                    mgmtsoc_litespi_grant <= 1'd1;
                end
            end
        end
        1'd1: begin
    ...
    mgmtsoc_litespi_state <= mgmtsoc_litespi_next_state;
    ...
    mgmtsoc_spimaster_state <= mgmtsoc_spimaster_next_state;
    ...
    mgmtsoc_rs232phy_rs232phytx_state <= mgmtsoc_rs232phy_rs232phytx_next_state;
    ...
    mgmtsoc_rs232phy_rs232phyrx_state <= mgmtsoc_rs232phy_rs232phyrx_next_state;
    ...
    mgmtsoc_uartwishbonebridge_rs232phytx_state <= mgmtsoc_uartwishbonebridge_rs232phytx_next_state;
    ...
    mgmtsoc_uartwishbonebridge_rs232phyrx_state <= mgmtsoc_uartwishbonebridge_rs232phyrx_next_state;
    ...
    mgmtsoc_uartwishbonebridge_state <= mgmtsoc_uartwishbonebridge_next_state;
    ...
    if (dbg_uart_reset) begin
        dbg_uart_incr <= 1'd0;
        mgmtsoc_uartwishbonebridge_state <= 3'd0;
    end
    ...
    mgmtsoc_wishbone2csr_state <= mgmtsoc_wishbone2csr_next_state;
    ...
    if (sys_rst) begin
        ...
        slave_sel_r <= 7'd0;
        count <= 20'd1000000;
        mgmtsoc_litespiphy_state <= 2'd0;
        mgmtsoc_litespi_grant <= 1'd0;
        mgmtsoc_litespi_state <= 4'd0;
        mgmtsoc_spimaster_state <= 2'd0;
        mgmtsoc_rs232phy_rs232phytx_state <= 1'd0;
        mgmtsoc_rs232phy_rs232phyrx_state <= 1'd0;
        mgmtsoc_uartwishbonebridge_rs232phytx_state <= 1'd0;
        mgmtsoc_uartwishbonebridge_rs232phyrx_state <= 1'd0;
        mgmtsoc_uartwishbonebridge_state <= 3'd0;
        mgmtsoc_wishbone2csr_state <= 1'd0;
    end
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-01-09 15:51:16.
//------------------------------------------------------------------------------
